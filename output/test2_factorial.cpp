...
int main() {
    [&]() { println("=== Cálculo de Factorial ==="); print("5! = "); println(factorial(5)); print("10! = "); println(factorial(10)); print("7! = "); println(factorial(7)); print("0! = "); println(factorial(0)); print("1! = "); println(factorial(1)); return 0; }();
    return 0;
}